...
os.makedirs("pronosticos_json", exist_ok=True)
...
for var in variables:
    ...
    # Nombre del archivo
    nombre_archivo = f"pronosticos_json/pronostico_{var.lower().replace(' ', '_')}.json"
...
with open("pronosticos_json/index.json", "w", encoding="utf-8") as f:
...
print(" EXPORTACIÓN COMPLETADA")
print(f"{'='*80}")
print("\n📁 Archivos JSON generados en: pronosticos_json/")
print("\n🎯 Para subir automáticamente a GitHub, ejecuta:")
